## [2.27.2-beta.0](https://github.com/team-telnyx/webrtc/compare/webrtc/v2.26.0...webrtc/v2.27.2-beta.0) (2026-06-18)
...
- Fix: preserve call mic mute state across local media changes (#667)
- feat: add skipTrailing option to skip VSP trailing pre-routing (#669)
- Fix: reattach session handling on reconnect (#666)
- Feat: add media device visibility to call reports (#668)
- feat: bye execution timeout guard (from VSDK-194) (#665)
- Fix: handle TIMEOUT gateway state with auto-reconnect (#670)
- docs: clarify AI conversation id target params (#661)
- chore: release webrtc 2.27.1 (#660)

...
* [constructor](broadcast.md#constructor)

### Properties

* [request](broadcast.md#request)
* [response](broadcast.md#response)
* [targetNodeId](broadcast.md#targetnodeid)

### Methods

* [buildRequest](broadcast.md#buildrequest)
* [toString](broadcast.md#tostring)

## Constructors

### constructor

\+ **new Broadcast**(`params?`: any): [Broadcast](broadcast.md)
...
**Returns:** [Broadcast](broadcast.md)
...
*Defined in [packages/js/src/Modules/Verto/messages/Verto.ts:37](https://github.com/team-telnyx/webrtc/blob/main/packages/js/src/Modules/Verto/messages/Verto.ts#L37)*

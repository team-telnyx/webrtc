...
* [response](bye.md#response)
* [targetNodeId](bye.md#targetnodeid)

### Methods

* [buildRequest](bye.md#buildrequest)
* [toString](bye.md#tostring)

## Constructors

### constructor

\+ **new Bye**(`params?`: any): [Bye](bye.md)
...
*Defined in [packages/js/src/Modules/Verto/messages/Verto.ts:22](https://github.com/team-telnyx/webrtc/blob/main/packages/js/src/Modules/Verto/messages/Verto.ts#L22)*

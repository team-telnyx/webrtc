...
* [constructor](unsubscribe.md#constructor)

### Properties

* [request](unsubscribe.md#request)
* [response](unsubscribe.md#response)
* [targetNodeId](unsubscribe.md#targetnodeid)

### Methods

* [buildRequest](unsubscribe.md#buildrequest)
* [toString](unsubscribe.md#tostring)

## Constructors

### constructor

\+ **new Unsubscribe**(`params?`: any): [Unsubscribe](unsubscribe.md)
...
**Returns:** [Unsubscribe](unsubscribe.md)
...
*Defined in [packages/js/src/Modules/Verto/messages/Verto.ts:47](https://github.com/team-telnyx/webrtc/blob/main/packages/js/src/Modules/Verto/messages/Verto.ts#L47)*

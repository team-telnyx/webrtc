...
export default class Verto extends BrowserSession {
   ...
   * @param options.telnyxCallControlId Telnyx Call Control ID, if using Call Control services
   * @param options.telnyxSessionId Telnyx call session ID, if using Call Control services
   * @param options.telnyxLegId Telnyx call leg ID, if using Call Control services

...
export default (klass: any) => {
  const CALL_PARAMS = {
    id: 'c1d19df5-5cdf-439a-9678-079549a43f40',
    ...
    describe('with 1-3 participants', () => {
      it('should handle layout-info for 1 people', () => {
        const eventData = JSON.parse(
          `{"contentType":"layout-info","canvasType":"mcu-personal-canvas","callID":"${CALL_PARAMS.id}","canvasInfo":{"canvasID":-1,"totalLayers":1,"layersUsed":0,"layoutFloorID":0,"layoutName":"1x1","canvasLayouts":[{"x":0,"y":0,"scale":360,"hscale":360,"scale":360,"zoom":0,"border":0,"floor":1,"overlap":0,"screenWidth":1920,"screenHeight":1080,"xPOS":0,"yPOS":0,"resID":"","audioPOS":"","memberID":105}],"scale":360}}`
        );
        MCULayoutEventHandler(instance, eventData);
        const canvasInfo = JSON.parse(
          `{"canvasId":-1,"totalLayers":1,"layersUsed":0,"layoutFloorId":0,"layoutName":"1x1","canvasLayouts":[{"x":0,"y":0,"scale":360,"hscale":360,"scale":360,"zoom":0,"border":0,"floor":1,"overlap":0,"screenWidth":1920,"screenHeight":1080,"xPos":0,"yPos":0,"resId":"","audioPos":"","participantId":105}],"scale":360}`
        );

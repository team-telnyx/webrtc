...
export const TELNYX_WARNING_CODES = {
  ...
  WEBSOCKET_CLOSE_REQUESTED: 36005,
  WEBSOCKET_CLOSED: 36006,
  NETWORK_CLOSE_DECISION: 36007,
  WEBSOCKET_RECONNECT_STARTED: 36008,
  WEBSOCKET_RECONNECT_SUCCEEDED: 36009,
  WEBSOCKET_RECONNECT_FAILED: 36010,
  CALL_RECOVERY_RESULT: 36011,
  SIGNALING_RECOVERY_REQUESTED: 36012,
} as const;

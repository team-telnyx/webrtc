...
export const TELNYX_WARNING_CODES = {
  ...
  ICE_CANDIDATE_PAIR_CHANGED: 33008,
  AUDIO_INPUT_DEVICE_CHANGE_SKIPPED: 33009,
  MULTIPLE_ACTIVE_CALLS_DETECTED: 33010,
  DUPLICATE_INBOUND_ANSWER: 33007,
  CODEC_PREFERENCES_UNSUPPORTED: 33009,
  PREFERRED_CODECS_UNAVAILABLE: 33010,

  // ── Authentication warnings (340xx) ─────────────────────────────────
  TOKEN_EXPIRING_SOON: 34001,

  // ── Session / reconnection warnings (350xx) ─────────────────────────
  UNKNOWN_REATTACHED_SESSION: 35002,

...
const MARK_LABELS: Record<string, string> = {
  ...
  'peer-creation-end': 'Peer Created',
  'start-negotiation': 'Start Negotiation',
  'create-offer': 'createOffer',
  'create-answer': 'createAnswer',
  'set-local-description': 'setLocalDescription',
  'ice-gathering-started': 'ICE Gathering Started',
  'first-candidate': 'First Candidate',
  'first-non-host-candidate': 'First Non-Host Candidate',
  'send-sdp': 'Send SDP',
  'ice-gathering-completed': 'ICE Gathering Completed',
  'ringing': 'Start Ringing',
  'telnyx-rtc-media': 'telnyx_rtc.media Arrived',
  'first-remote-media-track': 'First Remote Media Track',
  'set-remote-description': 'setRemoteDescription',
  'telnyx-rtc-answer': 'telnyx_rtc.answer Arrived',
  'ice-connected': 'ICE Connected',
  'dtls-connected': 'DTLS/Peer Connected',
  'call-active': 'Call Active',
  'answer-called': 'call.answer() Called',
};
